...
app.post('/api/bots', (req, res) => {
    const { name, discord_token, provider_id, model, vision_model, system_prompt, character_prompt, first_message, example_messages, prefill,
    ...
    const result = db.prepare(`
        INSERT INTO bots (name, discord_token, provider_id, model, vision_model, system_prompt, character_prompt, first_message, example_messages, prefill,
...
app.put('/api/bots/:id', (req, res) => {
    ...
    const fields = ['name', 'discord_token', 'provider_id', 'model', 'vision_model', 'system_prompt', 'character_prompt',
    ...
    db.prepare(`
        UPDATE bots SET name=?, discord_token=?, provider_id=?, model=?, vision_model=?, system_prompt=?, character_prompt=?,
            first_message=?, example_messages=?, prefill=?, temperature=?, top_p=?, max_tokens=?, max_prompt_tokens=?, presence_penalty=?, frequency_penalty=?, auto_start=?
        WHERE id = ?
    `).run(
        updates.name, updates.discord_token, updates.provider_id, updates.model, updates.vision_model,
