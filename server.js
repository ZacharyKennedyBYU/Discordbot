...
app.post('/api/bots', (req, res) => {
    const { name, discord_token, provider_id, model, system_prompt, character_prompt, prefill,
    ...
    const result = db.prepare(`
        INSERT INTO bots (name, discord_token, provider_id, model, system_prompt, character_prompt, prefill,
...
app.put('/api/bots/:id', (req, res) => {
    ...
    const fields = ['name', 'discord_token', 'provider_id', 'model', 'system_prompt', 'character_prompt',
        'prefill', 'temperature', 'top_p', 'max_tokens', 'max_prompt_tokens', 'presence_penalty', 'frequency_penalty', 'auto_start'];
    ...
    `).run(
        ...
        updates.system_prompt, updates.character_prompt, updates.prefill,
